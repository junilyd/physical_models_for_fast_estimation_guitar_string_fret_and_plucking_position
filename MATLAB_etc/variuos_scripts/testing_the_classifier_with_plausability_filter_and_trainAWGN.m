...
fileName = strcat(sprintf('mats/trained_model_of_firebird_SNR%1.0fdB_from_%1.0fth_fret',SNR,trainingFret));
load(fileName)
...
%    outputFileName = strcat(sprintf('~/repositories/guitar_string_finger_and_pluck_estimation/icassp_plucking_estimation/MATLAB/mats/results_BFretModel_w_plausibilty_trainSNR%1.0fdB_no_weighting',SNR),guitarType,sprintf('_40ms_from_%1.0fth_fret_betares%1.2fu_nFFT2^%1.0f.mat',trainingFret,betaRes*1e6,log2(nFFT)));
    outputFileName = strcat(sprintf('~/WASPAA2019/mats/results_BFretModel_w_plausibilty_trainSNR%1.0fdB_no_weighting',SNR),guitarType,sprintf('_40ms_from_%1.0fth_fret_betares%1.2fu_nFFT2^%1.0f.mat',trainingFret,betaRes*1e6,log2(nFFT)));
