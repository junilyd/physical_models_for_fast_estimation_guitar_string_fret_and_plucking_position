...
for numberOfFilesToRead = 1:10
    for string = stringOptions
        for fret = fretCounter
            ...
            recording = audioread(recordingPath);
...
for string = stringOptions 
    for fret = fretCounter
        ...
        outputFileName = strcat('/home/jmhh/WASPAA2019/mats/trained_model_of_',guitarType,sprintf('_SNR%1.0fdB',SNR),'_from_',sprintf('%1.0fth_fret',fretCounter-1),'.mat')
        save(outputFileName);
    end
    end
end
