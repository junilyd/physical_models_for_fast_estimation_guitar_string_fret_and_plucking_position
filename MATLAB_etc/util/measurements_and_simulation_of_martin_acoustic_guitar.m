...
load measurements.mat;%~/repositories/guitar_string_finger_and_pluck_estimation/util/inharmonicity/mats/BMean_Martin_40ms_wo.mat% Firebrand_40ms_wo.mat
mf=mean(f0TableMartin,3); mb =mean(BTableMartin,3);

minX = 305; maxX = 336;
minY = .68e-4; maxY = 1.26e-4;
figure(4); clf
title('Feature space of the acoustic guitar')
...
hold on ; scatter((f0TableMartin(:)),(BTableMartin(:)),6,'o','MarkerFaceColor',[.9 .69 .0 ],'MarkerEdgeColor',[0.91 0.61 0.01]);
